...
* Test case helps in early errors detection and understanding the business flow.
* TDD can be used as a good development model

### What:
* Logging using log4j2 framework

### Why:
* Used log4j2 for logging,it will generate the log file in application root directory,we can change the log file path in config file log4j2.xml.
...
### Future Improvements
* We can develop this project as a microservice which can generate rental statement on scale.
* We can implement complete flow of movie rental portal.
* We can develop below functionalities
 1. User Registration
 2. User Login
 3. Search Movies based on different criteria(i.e. Name,Actor,Year etc)
 4. Select Movies for Rental with rental details
 5. Generate Rental Statement
 6. Pay the bill
 7. Payment Receipt
 8. Show User Frequent Enter Points
 9. Movie Recommendations for the Customer
